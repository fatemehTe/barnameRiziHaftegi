<template>
    <div class="main">
        ...
        <div class="row">
            <div class="rounded-1 bg-e6e4e9 mt-3 col-md-6 d-flex flex-row align-items-center justify-content-between">
                <div> درس را برای مشاهده عملکرد خود انتخاب نمایید:</div>
                    <div class="p-1 w-50 m-auto">
                        <q-select
            ...
            <div class="col-md-6 d-flex flex-row align-items-center justify-content-between mt-3 p-3">
                <div class="bg-color-light-blue cursor-pointer rounded-1 c-ffffff text-center p-3 w-50 ms-1">ثبت و ارسال میزان تسط جدید</div>
                <div class="bg-01a4ab cursor-pointer rounded-1 c-ffffff text-center p-3  w-50 ms-1">ثبت و ارسال میزان علاقمندی جدید</div>
            </div>
        </div>
        <div class="rounded-1 bg-e6e4e9 p-3 mt-3">
            ...
            <div class="mt-3">
                <div class="bFirst p-3">
                    میزان اهمیت این درس در کنکور سراسری:
                ...
                <div class="row mt-3 mx-1 bThird p-3">
                    <div>
                    میزان خوانش درس</div>
                  
                    <div class="col-md-9">
                        <div class="tableLabel w-50 m-auto">طبق برنامه</div>
                        <div class="">    
                                ...
                                <table style="width:100%;" id="table">
                                    ...
                                    <tr height="50px" style="width:100%">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <span>تعداد/درصد تست تکلیف (یاد گرفتم)</span>
                                        </div>
                                        </td>
                                        <td style="text-align:center; font-weight:bold" >
                                        <div class="d-flex flex-column align-items-center">
                                            <span>(در توانم بود) تعداد/درصد تست تکلیف</span>
                                        </div>
                                        </td>
                                        <td style="text-align:center; font-weight:bold" >
                                        <div class="d-flex flex-column align-items-center">
                                            <span>درصد کل آزمون</span>
                                        </div>
                                        </td>
                                        <td style="text-align:center; font-weight:bold" >
                                        <div class="d-flex flex-column align-items-center">
                                            <span>پیش  روی برنامه</span>
                                        </div>
                                        </td>
                                        <td style="text-align:center; font-weight:bold" >
                                        <div class="d-flex flex-column align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="tableLabel w-50 m-auto">درصد اتمام درس</div>
                    </div>
                </div>
                <div class="mt-3">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="bSecond">
                                <div class="m-2 p-2 text-center">
                                        <span class="c-000000 fw-bold" > میزان تسلط شما در این درس</span>
                                </div>
                                <div class="m-2 bg-e1dee8 rounded-1 c-7244b0 p-2 px-3">
                                    <div>طبق آخرین داده های آزمون ها:</div>
                        ...
                        <div class="col-md-6">
                            <div class="bSecond">
                                ...
                                <div class="m-2 bg-e1dee8 rounded-1 c-7244b0 p-2 px-3">
                                    <div> میزان تسلط طبق نظرات ثبت شده</div>
                                </div>
                                <div class="m-2 p-2 bg-ffffff stickyScrollable-left" style="max-height: 240px; overflow-y: scroll">
                                        <table style="width:100%;" id="table">
                                            <thead id="tableHead">
